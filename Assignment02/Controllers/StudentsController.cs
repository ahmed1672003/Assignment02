...
namespace Assignment02.Controllers
{
    public class StudentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("SSN,FirstName,LastName,PhoneNumber,StreetName,StreetNumber,City,ZipCode,DepartmentId,Id")] Student student)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("SSN,FirstName,LastName,PhoneNumber,StreetName,StreetNumber,City,ZipCode,DepartmentId,Id")] Student student)
        {
            if (id != student.Id)
            {
                return NotFound();
